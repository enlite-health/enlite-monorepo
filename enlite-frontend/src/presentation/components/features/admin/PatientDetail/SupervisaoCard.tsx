...
export function SupervisaoCard() {
  ...
  return (
    <div className="bg-white rounded-card border-[1.5px] border-gray-700 p-6 sm:px-8 sm:py-10 flex flex-col gap-4">
      ...
      <Table>
        <TableHeader>
          <TableHead>{t('admin.patients.detail.supervisionCard.tableSupervisor')}</TableHead>
          <TableHead>{t('admin.patients.detail.supervisionCard.tableNotes')}</TableHead>
          <TableHead>{t('admin.patients.detail.supervisionCard.tableDate')}</TableHead>
          <TableHead>{t('admin.patients.detail.supervisionCard.tableStatus')}</TableHead>
        </TableHeader>
        <TableBody>
          <TableRow>
