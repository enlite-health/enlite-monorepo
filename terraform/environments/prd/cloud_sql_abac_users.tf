...
# um plan que precisa terminar em `0 to add, 0 to change` (fora do diff
# perpétuo do header X-Internal-Secret dos schedulers). Um `apply` que CRIE
# estes usuários também publicaria a senha-placeholder neles.
#
