  ...
  it('as famílias já viradas estão declaradas, rota a rota, com a célula certa', () => {
    ...
    expect(declaradas.map((r) => `${r.method} ${r.path} → ${r.cell}`).sort()).toEqual(
      [
        ...
        'GET /api/admin/catalogs/insurance-providers → patient:read',
        'GET /api/admin/funnel-stage-messages → messaging:read',
        'GET /api/admin/patients/:id/contracted-services → patient:read',
        'GET /api/admin/patients/:id/diagnoses → patient:read',
        ...
        'GET /api/admin/terminology/search → patient:read',
        'PATCH /api/admin/patients/:id/contracted-services/:sid → patient:write',
        'PATCH /api/admin/patients/:id/contracted-services/:sid/providers/:pid → patient:write',
        'PATCH /api/admin/patients/:id/diagnoses/:did → patient:write',
        'PATCH /api/admin/patients/:patientId/addresses/:addressId → patient:write',
        'POST /api/admin/catalogs/insurance-providers → patient:write',
        'POST /api/admin/map/corridor → patient:read',
        'POST /api/admin/patients/:id/contracted-services → patient:write',
        'POST /api/admin/patients/:id/contracted-services/:sid/providers → patient:write',
        'POST /api/admin/patients/:id/diagnoses → patient:write',
        'POST /api/admin/patients/map → patient:read',
