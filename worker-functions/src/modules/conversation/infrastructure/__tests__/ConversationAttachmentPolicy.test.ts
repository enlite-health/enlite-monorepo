 ...
 * `CHECK (content_type IN (...))` de `stored_files` (migration 459) — divergência entre os dois
...
describe('ConversationAttachmentPolicy', () => {
  ...
  it('ALLOWED_ATTACHMENT_CONTENT_TYPES tem os 4 tipos, na MESMA lista do CHECK de stored_files (migration 459)', () => {
