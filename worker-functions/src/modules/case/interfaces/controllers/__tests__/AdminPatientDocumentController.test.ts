...
describe('AdminPatientDocumentController', () => {
  ...
  describe('upload', () => {
    it('400 params inválidos', async () => {
      const c = new AdminPatientDocumentController({ execute: jest.fn() } as never, {} as never, db() as never);
      const res = mockRes();
    ...
    it('400 sem file', async () => {
      ...
      const c = new AdminPatientDocumentController(upload as never, {} as never, db() as never);
      const res = mockRes();
    ...
    it('404 paciente não existe', async () => {
      const c = new AdminPatientDocumentController({ execute: jest.fn() } as never, {} as never, db(false) as never);
      const res = mockRes();
  ...
  describe('getUrl', () => {
    it('400 params inválidos', async () => {
      const c = new AdminPatientDocumentController({} as never, { execute: jest.fn() } as never, db() as never);
      const res = mockRes();
    ...
    it('404 paciente não existe', async () => {
      const c = new AdminPatientDocumentController({} as never, { execute: jest.fn() } as never, db(false) as never);
      const res = mockRes();
    ...
    it('404 sem documento', async () => {
      ...
      const c = new AdminPatientDocumentController({} as never, getUrl as never, db() as never);
      const res = mockRes();
      await c.getUrl(mockReq({ params: { id: PID, documentId: DID } }), res);
      expect(res.status).toHaveBeenCalledWith(404);
    });
