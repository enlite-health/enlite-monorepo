      ...
      content: {
        'application/json': {
          schema: z.object({
            ...
            preferredAgeRange: z.array(z.string()).optional(),
            languages: z.array(z.string()).optional().openapi({ description: 'Idiomas (PII encriptada + blind index).' }),
            linkedinUrl: z.string().optional().openapi({ description: 'PII encriptada.' }),
